...
// void stiffsoft_tutti(TString s="feb22_23/totFAZIAPRE_4840_amd_geo_stiff.root,feb22_23/totFAZIAPRE_4840_amd_geo_soft.root,feb22_23/totFAZIAPRE_4840.root,feb22_23/totFAZIASYM_484835_amd_geo_stiff.root,feb22_23/totFAZIASYM_484835_amd_geo_soft.root,feb22_23/totFAZIASYM_484835.root,feb22_23/totINDRAFAZIA_64Ni64Ni_32_amd_geo_stiff.root,feb22_23/totINDRAFAZIA_64Ni64Ni_32_amd_geo_soft.root,feb22_23/totINDRAFAZIA_64Ni64Ni_32.root,feb22_23/totINDRAFAZIA_64Ni64Ni_52_amd_geo_stiff.root,feb22_23/totINDRAFAZIA_64Ni64Ni_52_amd_geo_soft.root,feb22_23/totINDRAFAZIA_64Ni64Ni_52.root")

void stiffsoft_tutti(TString s="feb22_23/totINDRAFAZIA_64Ni64Ni_32_amd_geo_stiff.root,feb22_23/totINDRAFAZIA_64Ni64Ni_32_amd_geo_soft.root,feb22_23/totINDRAFAZIA_64Ni64Ni_32.root,feb22_23/totINDRAFAZIA_64Ni64Ni_52_amd_geo_stiff.root,feb22_23/totINDRAFAZIA_64Ni64Ni_52_amd_geo_soft.root,feb22_23/totINDRAFAZIA_64Ni64Ni_52.root")

//void stiffsoft_tutti(TString s="feb22_23/totFAZIASYM_484835.root")
...
sym2b[j]=23;
 ...
 sym2b[j]=30;
  ...
  TH1F **h1=(TH1F**)malloc(nf*sizeof(TH1F*));
  TH1F **h2=(TH1F**)malloc(nf*sizeof(TH1F*));
...
//   TGraphErrors ***ggt2sub=(TGraphErrors***)malloc(nf*sizeof(TGraphErrors**));
   ...
   for(int j=0;j<nf;j++)
     {
       cout<<j<<endl;
            h1[j]=(TH1F*)f[j]->Get("hivalrec");
            h2[j]=(TH1F*)f[j]->Get("hivalbigO");
...
// 	  ggt2[j][iz]->SetMarkerSize(1.2);
 	  ...
 	  ggrec[j][iz]->SetMarkerStyle(sym2b[j]);
   ...
   for(int iz=1;iz<57;iz++)
     {
       ...
       for(int k=0;k<nf;k++)
	 {
	   if(ggqp[k][iz]->GetN()>0 ||ggrec[k][iz]->GetN()>0)
	     {
	       io=1;
	     }
	 }
       if(io==1)
	 {
	   ...
	   for(int k=0;k<nf;k++)
	         ...
	         if(!stit[k].Contains("stiff") &&!stit[k].Contains("soft"))
		 {
	       ...
	       leg[iz]->AddEntry(ggrec[k][iz],Form("%sBU", tit[k]),"p");
		 }
	     }
	   leg[iz]->Draw();
	 }
